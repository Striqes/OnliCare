            ...
            <form id="recordForm" method="POST">
                ...
                <div class="my-6 flex flex-col gap-4">
                    <label class="inline-flex items-center">
                        <input type="checkbox" id="nameToggle" class="form-checkbox">
                        <span class="ml-2">Patient is a registered user.</span>
                    </label>
                    <div id="patientIdInput" class="patient-input" style="display: none;">
                        <input type="text" name="patient_id" id="patient_id" class="block rounded-md border border-slate-300 bg-white px-3 py-4 font-semibold text-gray-500 shadow-sm focus:border-sky-500 focus:outline-none focus:ring-1 focus:ring-sky-500 sm:text-sm" placeholder="Enter Patient ID">
                    </div>
                    <div id="patientNameInput" class="patient-input">
                        <input type="text" name="first_name" id="fname" class="block rounded-md border border-slate-300 bg-white px-3 py-4 font-semibold text-gray-500 shadow-sm focus:border-sky-500 focus:outline-none focus:ring-1 focus:ring-sky-500 sm:text-sm " placeholder="Enter First Name" required>
                        <input type="text" name="middle_initial" id="mi" class="block rounded-md border border-slate-300 bg-white px-3 py-4 font-semibold text-gray-500 shadow-sm focus:border-sky-500 focus:outline-none focus:ring-1 focus:ring-sky-500 sm:text-sm mt-4" placeholder="Enter Middle Initial" required>
                        <input type="text" name="last_name" id="lname" class="block rounded-md border border-slate-300 bg-white px-3 py-4 font-semibold text-gray-500 shadow-sm focus:border-sky-500 focus:outline-none focus:ring-1 focus:ring-sky-500 sm:text-sm mt-4" placeholder="Enter Last Name" required>
                    </div>
                    <input type="text" name="diagnosis" class="block rounded-md border border-slate-300 bg-white px-3 py-4 font-semibold text-gray-500 shadow-sm focus:border-sky-500 focus:outline-none focus:ring-1 focus:ring-sky-500 sm:text-sm" placeholder="Enter Diagnosis" required>
                    <textarea name="feedback" class="block rounded-md border border-slate-300 bg-white px-3 py-4 font-semibold text-gray-500 shadow-sm focus:border-sky-500 focus:outline-none focus:ring-1 focus:ring-sky-500 sm:text-sm" placeholder="Enter Feedback" required></textarea>
                </div>
