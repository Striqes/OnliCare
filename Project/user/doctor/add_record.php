    ...
    <div class="mx-14 mt-10 border-2 border-yellow-400 rounded-lg pl-28 pr-28">
            ...
            <form id="recordForm" method="POST">
                ...
                <div class="my-6 flex flex-col gap-4">
                    <input type="text" name="patient_id" class="block rounded-md border border-slate-300 bg-white px-3 py-2 font-semibold text-gray-500 shadow-sm focus:border-sky-500 focus:outline-none focus:ring-1 focus:ring-sky-500 sm:text-sm" placeholder="Enter Patient ID">
                    <input type="text" name="diagnosis" class="block rounded-md border border-slate-300 bg-white px-3 py-4 font-semibold text-gray-500 shadow-sm focus:border-sky-500 focus:outline-none focus:ring-1 focus:ring-sky-500 sm:text-sm" placeholder="Enter Diagnosis">
                    <textarea name="feedback" class="block rounded-md border border-slate-300 bg-white px-3 py-4 font-semibold text-gray-500 shadow-sm focus:border-sky-500 focus:outline-none focus:ring-1 focus:ring-sky-500 sm:text-sm" placeholder="Enter Feedback"></textarea>
                </div>
